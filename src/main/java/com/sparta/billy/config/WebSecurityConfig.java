...
import com.sparta.billy.security.jwt.AccessDeniedHandlerException;
import com.sparta.billy.security.jwt.AuthenticationEntryPointException;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers("/members/kakao").permitAll()
